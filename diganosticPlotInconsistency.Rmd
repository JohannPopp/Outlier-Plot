...
I will work out the same for change in Pearson chi-square and cange in deviance soon.


  

  
```{r, eval=FALSE, "Change in Pearson chi-square", echo=FALSE, include=FALSE}
...
points(ldx$P, ldx$dChisq, 
       col = "#FF000090", pch = 1, cex = 1.2, lwd = 1.5)
legend(0.4, 15, pch = c(16, 1), col = c("blue", "red"), cex = 0.8,
       legend = c("Photograph of Fig. 5.13 in\nHosmer et al. 2013", "logisticDx::dx"))

# based on leverage times n
img513 <- readPNG("HLS5-13blue.png")
plot(1:2, xlim = c(0, 0.8), ylim = c(0, 18), bty = "n", xlab = "Estimated probability", ylab = "Change in Pearson chi-square", main = "Change in Pearson chi-square based on logisticDX::dx\n with leverage times n vs. published figure 5.13")
rasterImage(img513, xleft = -0.025, ybottom = -0.9, xright = 0.824, ytop = 16.7)
points(ldx$P, nsPr^2, 
       col = "#FF000090", pch = 1, cex = 1.2, lwd = 1.5)
legend(0.4, 15, pch = c(16, 1), cex = 0.8, col = c("blue", "red"),
       legend = c("Photograph of Fig. 5.13 in\nHosmer et al. 2013", 
                  "logisticDx::dx; leverage times n"))
```
...
points(ldx$P, ldx$dDev, 
       col = "#FF000090", pch = 1, cex = 1.2, lwd = 1.5)
# points(ldx$P, ldx$dDev / (1-H), 
#        col = "#00602090", pch = 16, cex = 1, lwd = 1.5)
legend(0.3, 6, pch = c(16, 1), cex = 0.8, col = c("blue", "red"),
       legend = c("Photograph of Fig. 5.14 in\nHosmer et al. 2013", "logisticDX::dx"))
